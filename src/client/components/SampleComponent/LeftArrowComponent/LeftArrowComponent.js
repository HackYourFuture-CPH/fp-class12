...
export default function LeftArrowComponent() {
  return (
    <div ClassName='left_arrow_component'>
      <svg /* onClick={props.clickLeftArrow} */ ClassName="bi bi-arrow-left-circle" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
