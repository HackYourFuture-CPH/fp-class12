...
export default function RightArrowComponent() {
  return (
    <div ClassName="right_arrow_component">
      <svg /* onClick={props.clickRightArrow} */ ClassName="bi bi-arrow-right-circle" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
